...
************************************
music shield firmware v1.2
This is for the IDE,Arduino 1.0
change log:
1.For music.pde,chang the file extension from .pde to .ino.
 #include <NewSoftSerial.h> change to #include <SoftwareSerial.h>.
 NewSoftSerial change to SoftwareSerial.
2.For player.cpp,
  #include <NewSoftSerial.h> change to #include <SoftwareSerial.h>.
  NewSoftSerial change to SoftwareSerial.
3.For buffer.h && filesys.cpp
  #include "WProgram.h" change to #include <Arduino.h>
4.For buffer.h,
  //typedef unsigned char byte change to typedef unsigned char byte

2012-1-31 16:51:00 Piggy